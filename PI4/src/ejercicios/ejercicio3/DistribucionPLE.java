...
public class DistribucionPLE {
	 ...
	 public static void ejercicio3_model() throws IOException {
	    	DatosDistribucion.iniDatos("ficheros/Ejercicio3DatosEntrada3.txt");
...
//			AuxGrammar.generate(Ejercicio1PLE.class,"lsi_models/Ejercicio1.lsi","gurobi_modelps/Ejercicio1-2.lp");
			AuxGrammar.generate(DistribucionPLE.class,"modelos/ejercicio3.lsi","gurobi_modelos/Ejercicio3-3.lp");
			GurobiSolution solution = GurobiLp.gurobi("gurobi_modelos/Ejercicio3-3.lp");
